...
class DeprecatedFunctions
{
	public static function implement(funk:FunkinLua)
	{
	    ...
	    //kade
		Lua_helper.add_callback(lua,"changeDadCharacter", FunkinLua.changeDadCharacter);
		Lua_helper.add_callback(lua,"changeBoyfriendCharacter", FunkinLua.changeBoyfriendCharacter);
		Lua_helper.add_callback(lua,"changeGFCharacter", FunkinLua.changeGFCharacter);
